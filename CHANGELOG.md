...
> Print-era PDF extraction fixes — words drawn as single string literals no longer fragment, stroke-width-encoded table rules are detected, and 90°-rotated pages read in their rotated frame with rotation exposed on words.
