...
#[test]
fn the_source_trailer_has_an_id_to_carry() {
...
#[test]
fn the_added_trailer_carries_id() {
...
#[test]
fn the_added_trailer_still_has_size_prev_and_root() {
    let (original_len, all) = save_incrementally();
    let appended = appended_region(&all, original_len);
...
#[test]
fn the_incrementally_updated_file_still_reads() {
