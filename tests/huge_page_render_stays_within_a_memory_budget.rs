...
#[test]
fn an_enormous_page_is_scaled_down_to_fit_the_budget() {
...
#[test]
fn an_over_budget_page_is_scaled_down_rather_than_cropped() {
...
#[test]
fn an_ordinary_page_is_left_at_its_natural_size() {
